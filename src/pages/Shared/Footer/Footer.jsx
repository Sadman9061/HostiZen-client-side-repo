    ...
    return (
        ...
        <h1 className="text-3xl font-black  bg-gradient-to-r from-[#8ABB6A] to-[#8ABB6A]  bg-clip-text text-transparent text-center ml-4 ">Hosti<span className="text-[#FFDB74]">Zen</span></h1>
                ...
                <nav>
                    ...
                    <a className="link link-hover interactable">Meals</a>
                    <a className="link link-hover interactable">Upcoming Meals</a>
            ...
            <div className="relative p-4 pb-6 bg-[#2B3440] ">
                ...
                <p className=" footer-center text-white">Copyright © 2023 - All right reserved by HostiZen  Ltd</p>
            </div>
        </div>
    );
};
